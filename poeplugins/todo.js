...
`;
  ...
  fetch(jsonfile)
    ...
    .then((jsondata) => {
        let dados = select(jsondata, multipatterncheck_exclude, "ddesign " + par);
        ...
        <style>
         ...
         .listatodo {
            display: grid;
            grid-template-columns: 3fr 1fr 0.7fr 1fr 2fr [ultimacol] 2fr [fim];
            gap: 8px 16px;
        ...
        <div><a class='grouplink' style='text-transform: uppercase; display: inline;' href='https://docs.google.com/spreadsheets/d/1H74Dro8Qg4s_1adknglOm8mR6Y6f9WdzYDLaAY-15oU/edit#gid=444640757'>Gerenciar [ <b>${arr.length}</b> ]</a> &nbsp; <a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:sessionStorage.setItem("tipo","atividade"); addinput("")'>To-do</a> &nbsp; <a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:sessionStorage.setItem("tipo","timeline"); addinput("")'>Timeline</a> &nbsp; <a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:sessionStorage.setItem("tipo","cronograma"); addinput("")'>Cronograma</a></div>
        <div><a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:addinput("workbench ")'>Workbench</a> &nbsp; <a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:addinput("task ")'>Tasks</a> &nbsp; <a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:addinput("longjob ")'>Long Jobs</a></div>
        <div><a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:addinput("disciplinas ")'>Disciplinas</a> &nbsp; <a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:addinput("laboratório ")'>Laboratório</a> &nbsp; <a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:addinput("top ")'>Prioridades</a> &nbsp; <a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:setinput("/todo ")'>/</a></div>
        </div>
        ...
        `;
            ...
            for (let l = 0; l < arr.length; l++) {
                ...
                if (typeof arr[l].Status == 'undefined') {
                    arr[l].Status = "na fila";
                }
            
            
                if (arr[l].Ativo != '' && arr[l].Atividade != '') {

                    if (par != `arquivado` && arr[l].Status != `arquivado`) {
        ...
        if (sessionStorage.getItem('tipo') == "ação") {
            ...
            for (let linha = 0; linha < tamanhodaslinhas; linha++) {
                for (let c = 0; c < quaisacoes.length; c++) {
                    ...
                    if (typeof listasatvidadespacoes[c][linha].Status == 'undefined') {
                        listasatvidadespacoes[c][linha].Status = "na fila";
                    }
            ...
            code += `<div style='grid-column: 1 / Fim;'><br><br><a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:sessionStorage.setItem("tipo","atividade"); addinput("")'>Atividade</a> &nbsp; <a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:sessionStorage.setItem("tipo","status"); addinput("")'>Status</a></div>`;
      ...
      if (sessionStorage.getItem('tipo') == "status") {
          ...
          let quaisacoes = ['na fila', 'fazendo', 'feito'];
            ...
            code += `<div style='grid-column: 1 / Fim;'><br><br><a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:sessionStorage.setItem("tipo","atividade"); addinput("")'>Atividade</a> &nbsp; <a class='grouplink' style='text-transform: uppercase; display: inline;' href='javascript:sessionStorage.setItem("tipo","ação"); addinput("")'>Ação</a></div>`;
